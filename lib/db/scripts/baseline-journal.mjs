...
const CREATES = {
  ...
  "0011_onboarding_preferences": [["onboarding_preferences", null]],
  "0012_budget_plans_and_onboarding_allocations": [["budget_plans", null]],
  "0013_square_jocasta": [["users", "password_hash"]],
  "0014_category_archive_cleanup": [["budget_categories", "is_archived"]],
  "0015_bank_dates_and_decimals": [["bank_accounts", "opening_balance_date"]],
  "0016_editable_priority_tiers": [["groups", "priority_tiers"]],
  "0017_subscription_packages": [
    ["subscription_plans", null],
    ["group_subscriptions", null],
  ],
};
