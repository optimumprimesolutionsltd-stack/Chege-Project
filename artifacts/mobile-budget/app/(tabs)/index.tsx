...
const styles = StyleSheet.create({
  ...
  overviewNavButton: { width: '47%', minHeight: 78, borderWidth: 1, borderRadius: 12, paddingHorizontal: 7, paddingVertical: 9, flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 2, position: 'relative' },
  overviewNavButtonText: { width: '100%', maxWidth: '100%', fontSize: 11, lineHeight: 15, textAlign: 'center', fontFamily: 'Inter_600SemiBold' },
  overviewNavButtonDescription: { width: '100%', maxWidth: '100%', fontSize: 9, lineHeight: 12, textAlign: 'center', fontFamily: 'Inter_400Regular' },
