 ...
 * group's, and the contributions statement reports it on its own line rather
 * than crediting anybody. It was called "Joint bank", which read as a pooled
 * account — a word already taken on that screen by the actual bank accounts.
 *
